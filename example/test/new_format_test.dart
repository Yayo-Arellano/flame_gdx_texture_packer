...
void main() {
  ...
  group('Multiple pages atlas', () {
    const atlasPath = 'newFormat/multiplePages/MultiplePageAtlasMap.atlas';
    test('Texture atlas contains 12 Sprites', () async {
      final atlas = await TextureAtlas().load(atlasPath);
  ...
  group('Single page atlas', () {
    const atlasPath = 'newFormat/singlePage/SinglePageAtlasMap.atlas';
    test('Texture atlas contains 12 Sprites', () async {
      final atlas = await TextureAtlas().load(atlasPath);
      expect(atlas.sprites.length, 12);
    });
